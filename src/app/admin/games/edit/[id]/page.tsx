...
const availablePlatforms = [
  "iOS", "Android", "PC", "PlayStation", "Xbox", "Nintendo Switch", "Web Browser"
]
      ...
      try {
        ...
        if (response.ok) {
          ...
          setFormData({
            ...
            genre: game.genre || "",
            platforms: game.platform ? game.platform.split(', ').filter(Boolean) : [],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/games/${gameId}`, {
        ...
        body: JSON.stringify({
          ...formData,
          platform: formData.platforms.length > 0 ? formData.platforms.join(', ') : null
        }),
      })
      ...
      if (response.ok) {
        ...
        setError(errorData.error || 'Erreur lors de la modification du jeu')
      }
    } catch (error) {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        <div className="flex items-center justify-center h-32">
          ...
          <span className="ml-2">Chargement du jeu...</span>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold">Modifier le jeu</h1>
          <p className="text-muted-foreground">Modifier les informations du jeu</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Modifiez les informations de base du jeu
          </CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <TagInput
                  ...
                  placeholder="Ajouter des plateformes..."
                  suggestions={availablePlatforms}
                />
                <p className="text-xs text-muted-foreground">
                  Sélectionnez toutes les plateformes supportées
                </p>
              </div>
            </div>
